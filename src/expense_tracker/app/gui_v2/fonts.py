...
_FONTS_DIR = Path(__file__).resolve().parent.parent / "gui" / "resources" / "fonts"
...
def playfair_display(size: int, weight: int = 700) -> QFont:
...
def noto_naskh(size: int, weight: int = 700) -> QFont:
    """Noto Naskh Arabic — for the ميزان brand wordmark."""
