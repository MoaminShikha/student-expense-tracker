...
_SS = f"""
    ...
    QLineEdit:focus, QComboBox:focus, QDateEdit:focus {{ border: 2px solid {tokens.FOCUS}; }}
    QComboBox QAbstractItemView {{
        background: {tokens.SURFACE}; color: {tokens.FG};
        selection-background-color: {tokens.PAPER_WARM}; border: 1px solid {tokens.HAIRLINE};
    }}
...
class AddSpendDialog(QDialog):
    """Modal dialog to add one spend transaction. Exposes .amount, .description, .category, .spent_on on accept."""
