...
class BalanceViewModel:
    ...
    Contains pre-formatted strings and timeline percentages for direct
    consumption by views. Built by the controller from a domain BalanceSnapshot;
    never manipulates domain state.
    """
